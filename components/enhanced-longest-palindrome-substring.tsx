...
export function EnhancedLongestPalindromeSubstring() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 p-8">
      ...
      <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-4xl">
        ...
        <div className="mb-8 relative">
          <div className="flex justify-center items-center space-x-4 mb-4">
            {input.split("").map((char, index) => (
              <motion.div
                key={index}
                className={`w-14 h-14 flex items-center justify-center text-xl font-semibold border-2 rounded-lg
                  ${index === center ? "bg-yellow-100 border-yellow-400" : ""}
                  ${
        ...
        <div className="grid grid-cols-2 gap-6 mb-8">
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg">
            ...
            <div className="text-2xl font-bold text-blue-600 bg-white p-3 rounded-md min-h-[3rem] flex items-center justify-center">
              {currentPalindrome || "-"}
            </div>
          </div>
          <div className="bg-gradient-to-r from-green-50 to-green-100 p-4 rounded-lg">
            ...
            <div className="text-2xl font-bold text-green-600 bg-white p-3 rounded-md min-h-[3rem] flex items-center justify-center">
